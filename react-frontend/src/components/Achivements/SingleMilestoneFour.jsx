...
const SingleMilestoneFour = (props) => {
    const { itemClass, skillID, skillImg, skillTitle, courseName, courseAuthor, courseAuthorImg, courseLesson, courseEnrolled, coursePrice, skillSharingPostLikes } = props;
	return(
   ...
   32 Comments
                ...
                <h4 className="case-title">
                    <Link to={`/skill-feed/${skillID}`}>
                        {skillTitle ? skillTitle : 'The Most Complete Design Thinking Course On The Market.'}
                    </Link>
                </h4>
...
export default SingleMilestoneFour