...
const Breadcrumb = (props) => {
    const { postTitle, postBannerImg, postCategory,postAuthor,postAuthorImg,postPublishedDate,postTotalView,postDescription,weeks } = props;

	return (
		<div className="react-breadcrumbs single-page-breadcrumbs">
			<div className="breadcrumbs-wrap">
				<img className="desktop" src={require(`../../assets/images/blog/post-banner1.jpg`)} alt="Breadcrumbs" />
				<img className="mobile" src={require(`../../assets/images/blog/post-banner1.jpg`)} alt="Breadcrumbs" />
					...
					<div className="container">
						<div className="breadcrumbs-text">
							...
							<ul className="user-section">
								<li className="user">
									<span><img src={postAuthorImg} alt="user" /></span>
